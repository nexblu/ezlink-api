...
Revision ID: 542e4dfa1fd4
Revises: 
Create Date: 2024-06-23 11:03:00.144948
...
def downgrade():
    ...
    sa.CheckConstraint('length(uuid::text) > 0', name='non_empty_uuid'),
    sa.CheckConstraint('updated_at > 0::double precision', name='positive_updated_at'),
    sa.CheckConstraint('user_id > 0', name='positive_user_id'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='short_url_user_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='short_url_pkey'),
    sa.UniqueConstraint('aliases', name='short_url_aliases_key'),
    sa.UniqueConstraint('name_file', name='short_url_name_file_key'),
    sa.UniqueConstraint('url', name='short_url_url_key'),
    sa.UniqueConstraint('user_id', name='short_url_user_id_key'),
    sa.UniqueConstraint('uuid', name='short_url_uuid_key')
    )
